...
def get_rag_instance(
    ...
    **lightrag_kwargs,
    ...
    rag_config = RAGAnythingConfig(
        ...
        else DEFAULT_ENABLE_IMAGE_PROCESSING,
        enable_table_processing=enable_table_processing
        if enable_table_processing is not None
        else DEFAULT_ENABLE_TABLE_PROCESSING,
        enable_equation_processing=enable_equation_processing
        if enable_equation_processing is not None
        else DEFAULT_ENABLE_EQUATION_PROCESSING,
    )
